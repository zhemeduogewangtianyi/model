package com.oak.model.controller.picture;
...
public class PictureController {
    ...
    public ModelAndView list(){
        ...
        mav.setViewName("/manager/picture/list");
        return mav;
    }
    ...
    public ModelAndView detail(Long id){
        ...
        mav.setViewName("/manager/picture/detail");
        mav.addObject("vo",vo);
        return mav;
    }
    ...
    public ModelAndView openAdd(){
        ModelAndView mav = new ModelAndView();
        mav.setViewName("/manager/picture/add_picture");
        return mav;
    }
