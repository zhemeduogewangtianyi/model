package com.oak.model.controller.user;

import com.alibaba.fastjson.JSONObject;
import com.oak.model.baseEnum.BizEnum;
import com.oak.model.entity.responseResult.ResponseResult;
import com.oak.model.entity.user.UserInfo;
import com.oak.model.entity.user.UserInfoVO;
...
import static com.yundang.com.yundangApi.httpGets;
import static com.yundang.com.yundangApi.httpPosts;
...
public class UserController {
    ...
    public ModelAndView list() {
        ...
        mav.setViewName("/manager/user/list");
        return mav;
    }
    ...
    public ModelAndView detail(Long uid) {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("/manager/user/user_detail");
    ...
    public ModelAndView openUpdate(Long uid) {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("/manager/user/update_password");
