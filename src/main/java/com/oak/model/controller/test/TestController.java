package com.oak.model.controller.test;

import com.alibaba.fastjson.JSONObject;
import com.oak.model.baseEnum.BizEnum;
import com.oak.model.baseEnum.CommonEnum;
...
public class TestController {
    ...
    public ModelAndView list(){
        ...
        mav.setViewName("/manager/test/list");
        return mav;
    }
    ...
    public ResponseResult pageQuery(TestParam param){
        ...
        try{
            File file = new File("C:\\Users\\Administrator\\Desktop\\225471.txt");
    ...
    public ModelAndView openAdd(){
        ModelAndView mav = new ModelAndView();
        mav.setViewName("/manager/test/add_category");
        return mav;
    }
    ...
    public ModelAndView openDetail(Long id){
        ModelAndView mav = new ModelAndView();
        mav.setViewName("/manager/test/test_detail");
