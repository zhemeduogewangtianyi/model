package com.oak.model.application.shiro;

import com.oak.model.application.shiro.shiroRealm.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager){
        ...
        //配置记住我或认证通过可以访问的地址
        filterChainDefinitionMap.put("/manager/index", "user");
        filterChainDefinitionMap.put("/", "user");


        //定义过滤链 ------ /** 要配置在最下面  --------  authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问
        filterChainDefinitionMap.put("/media/**/*.css","anon");
        filterChainDefinitionMap.put("/media/**/*.js","anon");
        filterChainDefinitionMap.put("/media/**/*.png","anon");
        filterChainDefinitionMap.put("/media/**/*.jpg","anon");
        filterChainDefinitionMap.put("/media/**/*.ico","anon");
        filterChainDefinitionMap.put("/media/**/*.psd","anon");
        filterChainDefinitionMap.put("/media/**/**/**/*.css","anon");
        filterChainDefinitionMap.put("/media/**/**/*.js","anon");
